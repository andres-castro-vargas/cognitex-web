...
export default function Footer({ showMarquee = false }: { showMarquee?: boolean }) {
  ...
  const gradientOverlayStyle: React.CSSProperties = {
    ...
    inset: 0,
    background: `
      radial-gradient(ellipse 900px 650px at bottom left, rgba(59, 130, 246, 0.8) 0%, rgba(59, 130, 246, 0.5) 25%, rgba(59, 130, 246, 0.2) 50%, transparent 75%),
      radial-gradient(ellipse 600px 500px at bottom right, rgba(30, 64, 175, 0.25) 0%, transparent 60%)
    `,
    pointerEvents: 'none',
    zIndex: 0
  };
